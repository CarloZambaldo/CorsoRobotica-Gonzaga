/*
  Silent Night + Saluto studenti su LCD 20x4
  Buzzer su pin 11
*/
...
// Silent Night melody (pitch, duration)
int melody[] = {
...
void setup() {
	...
	// Prima schermata prima di suonare
	updateLCDGreeting();
}

void loop() {
	// Suona la canzone e aggiorna LCD ogni tot note
	for (int thisNote = 0; thisNote < notes * 2; thisNote = thisNote + 2) {

		// Ogni tot “step” cambia studente/complimento
		if ((thisNote % 8) == 0) {
			updateLCDGreeting();
		}
